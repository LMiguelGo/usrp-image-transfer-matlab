...
set COMPILER=C:\ProgramData\MATLAB\SupportPackages\R2025b\3P.instrset\mingw_w64.instrset\bin\gcc
                ...
                set LINKFLAGS=-m64 -Wl,--no-undefined -shared -static -L"C:\Program Files\MATLAB\R2025b\extern\lib\win64\mingw64" -llibmx -llibmex -llibmat -lm -llibmwlapack -llibmwblas -Wl,"C:\Program Files\MATLAB\R2025b/extern/lib/win64/mingw64/mexFunction.def"
                set LINKDEBUGFLAGS=-g
                set NAME_OUTPUT=-o "%OUTDIR%%MEX_NAME%%MEX_EXT%"
set PATH=C:\ProgramData\MATLAB\SupportPackages\R2025b\3P.instrset\mingw_w64.instrset\bin;C:\Program Files\MATLAB\R2025b\extern\include\win64;C:\Program Files\MATLAB\R2025b\extern\include;C:\Program Files\MATLAB\R2025b\simulink\include;C:\Program Files\MATLAB\R2025b\lib\win64;%MATLAB_BIN%;%PATH%
...
set LIBPATH=C:\Program Files\MATLAB\R2025b\extern\lib\win64;%LIBPATH%

gmake SHELL="cmd" -f transmisor_cgxe.gmk
