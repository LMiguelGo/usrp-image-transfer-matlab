#ifndef __fbkVLcGTGg3rtCem5knjcB_h__
#define __fbkVLcGTGg3rtCem5knjcB_h__
...
#ifndef struct_tag_yVAYMOe9kH0ctCVICDcnkF
#define struct_tag_yVAYMOe9kH0ctCVICDcnkF

struct tag_yVAYMOe9kH0ctCVICDcnkF
{
  int32_T isInitialized;
  boolean_T TunablePropsChanged;
};

#endif                                 /* struct_tag_yVAYMOe9kH0ctCVICDcnkF */

#ifndef typedef_comm_internal_BernoulliBinaryGenerator
#define typedef_comm_internal_BernoulliBinaryGenerator

typedef struct tag_yVAYMOe9kH0ctCVICDcnkF comm_internal_BernoulliBinaryGenerator;

#endif                                 /* typedef_comm_internal_BernoulliBinaryGenerator */
...
#ifndef struct_tag_coqQ82yPlry9otcWheFsc
#define struct_tag_coqQ82yPlry9otcWheFsc

struct tag_coqQ82yPlry9otcWheFsc
{
  char_T f1[3];
  char_T f2[4];
  char_T f3[2];
...
#endif                                 /* struct_tag_coqQ82yPlry9otcWheFsc */

#ifndef typedef_cell
#define typedef_cell

typedef struct tag_coqQ82yPlry9otcWheFsc cell;

#endif                                 /* typedef_cell */

#ifndef struct_tag_kpk8M1z9jW1AJlZkXqb6P
#define struct_tag_kpk8M1z9jW1AJlZkXqb6P

struct tag_kpk8M1z9jW1AJlZkXqb6P
{
  char_T f1[6];
  char_T f2[4];
  char_T f3[6];
...
#endif                                 /* struct_tag_kpk8M1z9jW1AJlZkXqb6P */

#ifndef typedef_b_cell
#define typedef_b_cell

typedef struct tag_kpk8M1z9jW1AJlZkXqb6P b_cell;

#endif                                 /* typedef_b_cell */

#ifndef struct_tag_P5X02wf9Xo961saWYkqGYH
#define struct_tag_P5X02wf9Xo961saWYkqGYH

struct tag_P5X02wf9Xo961saWYkqGYH
{
  char_T f1[6];
  char_T f2[6];
  char_T f3[6];
...
#endif                                 /* struct_tag_P5X02wf9Xo961saWYkqGYH */

#ifndef typedef_c_cell
#define typedef_c_cell

typedef struct tag_P5X02wf9Xo961saWYkqGYH c_cell;
...
#ifndef struct_tag_sQzQiBCARYvpgQjjVU3eyC
#define struct_tag_sQzQiBCARYvpgQjjVU3eyC

struct tag_sQzQiBCARYvpgQjjVU3eyC
{
  cell _data;
};

#endif                                 /* struct_tag_sQzQiBCARYvpgQjjVU3eyC */

#ifndef typedef_s_sQzQiBCARYvpgQjjVU3eyC
#define typedef_s_sQzQiBCARYvpgQjjVU3eyC

typedef struct tag_sQzQiBCARYvpgQjjVU3eyC s_sQzQiBCARYvpgQjjVU3eyC;

#endif                                 /* typedef_s_sQzQiBCARYvpgQjjVU3eyC */

#ifndef struct_tag_yRbBlfv5EQ7ktjNRCACeyB
#define struct_tag_yRbBlfv5EQ7ktjNRCACeyB

struct tag_yRbBlfv5EQ7ktjNRCACeyB
{
  b_cell _data;
};

#endif                                 /* struct_tag_yRbBlfv5EQ7ktjNRCACeyB */

#ifndef typedef_s_yRbBlfv5EQ7ktjNRCACeyB
#define typedef_s_yRbBlfv5EQ7ktjNRCACeyB

typedef struct tag_yRbBlfv5EQ7ktjNRCACeyB s_yRbBlfv5EQ7ktjNRCACeyB;

#endif                                 /* typedef_s_yRbBlfv5EQ7ktjNRCACeyB */

#ifndef struct_tag_swIliF8mbMFrgZk496G9w
#define struct_tag_swIliF8mbMFrgZk496G9w

struct tag_swIliF8mbMFrgZk496G9w
{
  c_cell _data;
};

#endif                                 /* struct_tag_swIliF8mbMFrgZk496G9w */

#ifndef typedef_s_swIliF8mbMFrgZk496G9w
#define typedef_s_swIliF8mbMFrgZk496G9w

typedef struct tag_swIliF8mbMFrgZk496G9w s_swIliF8mbMFrgZk496G9w;

#endif                                 /* typedef_s_swIliF8mbMFrgZk496G9w */
...
#ifndef typedef_InstanceStruct_fbkVLcGTGg3rtCem5knjcB
#define typedef_InstanceStruct_fbkVLcGTGg3rtCem5knjcB

typedef struct {
  SimStruct *S;
  comm_internal_BernoulliBinaryGenerator sysobj;
...
#endif                                 /* typedef_InstanceStruct_fbkVLcGTGg3rtCem5knjcB */
...
extern void method_dispatcher_fbkVLcGTGg3rtCem5knjcB(SimStruct *S, int_T method,
  void* data);
