...
% Required Software_>.
% * USRP E3xx, N3xx, X3xx, or X4xx series radio and
...
% block and run the model. You can run the |sdruqpskrx.slx| QPSK Receiver
% with USRP Hardware model with an additional USRP device to receive the
% transmitted signal.
close_system([modelname '/Bit Generation']);
close_system(modelname, 0);

%% Exploring the Example
% Due to hardware variations among the USRP boards, a frequency offset will
% likely exist between the USRP transmitter hardware and the USRP receiver
% hardware. In that case, perform a manual frequency calibration using the
% companion frequency offset calibration |sdrufreqcalib.slx| transmitter
% and |sdrufreqcalib_rx.slx| receiver models and examine the resulting
% behavior.
% 
