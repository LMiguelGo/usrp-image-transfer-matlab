...
% calibration |sdrufreqcalib.slx| transmitter and 
% |sdrufreqcalib_rx.slx| receiver models with your USRP transmitter
...
% |sdruqpsktx.slx| QPSK Transmitter with USRP Hardware model
